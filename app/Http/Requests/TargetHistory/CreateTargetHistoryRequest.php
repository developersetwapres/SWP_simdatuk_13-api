...
class CreateTargetHistoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'users.*.work_behavior_rating' => 'nullable|numeric|in:1,2,3',
            'users.*.employee_performance_predicate' => 'nullable|numeric|in:1,2,3,4,5',
            'users.*.organizational_performance_achievement' => 'nullable|numeric|in:1,2,3',
        ];
    }
